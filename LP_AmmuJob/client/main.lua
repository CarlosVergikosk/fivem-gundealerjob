...
function OpenCloakroomMenu()
	...
	elseif grade == 'officer' then
		table.insert(elements, {label = _U('ammu_wear'), value = 'officer_wear'})
	elseif grade == 'sergeant' then
		table.insert(elements, {label = _U('ammu_wear'), value = 'sergeant_wear'})
	elseif grade == 'intendent' then
		table.insert(elements, {label = _U('ammu_wear'), value = 'intendent_wear'})
	elseif grade == 'lieutenant' then
		table.insert(elements, {label = _U('ammu_wear'), value = 'lieutenant_wear'})
	elseif grade == 'chef' then
		table.insert(elements, {label = _U('ammu_wear'), value = 'chef_wear'})
	...
	if Config.EnableNonFreemodePeds then
		...
		table.insert(elements, {label = 'ammu wear', value = 'freemode_ped', maleModel = 's_m_y_blackops_01', femaleModel = 's_m_y_blackops_01'})
...
AddEventHandler('esx:setJob', function(job)
	...
	Citizen.Wait(5000)
	TriggerServerEvent('esx_ammujob:forceBlip')
end)
